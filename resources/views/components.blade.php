...
<body>
    ...
    <!-- Necessary buttons:
    <button type="button" class="btn btn-light" style="background-color: #E8D5B9;">berke yilmaz</button>
    <button type="button" class="btn btn-light" style="background-color: #FF9595;">berke yilmaz</button>
     -->
     <!-- Search bar
     <div class="d-inline-flex p-2 bd-highlight">
        <nav class="navbar navbar-light bg-light">
            <form class="form-inline">
                ...
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Ara</i></button>
            </form>
        </nav>
    </div>
  -->

    <!-- Ogretmen Ekleme Overlay
    <div class="bigbox">
        ...
        <form action="#">
            ...
            <button type="button" class="btn btn-light" style="background-color: #FF9595; margin-left: 120px;">Öğretmen
                Ekle</button>
        </form>
    </div> -->
