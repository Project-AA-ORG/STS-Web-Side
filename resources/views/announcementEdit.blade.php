    ...
    <div class="centerEdit">
        ...
        <div id="mainbox" class="duzenle container">
            ...
            <div class="row_1 row">
                    ...
                    <form id="yourFormId" action="{{ route('get-update-announcement') }}" method="POST">
                        ...
                        <div class="row">
                            <input type="text" name="announcement_title" id="announcement_title"
                                value="{{ $data['announcement']->announcement_title }}" required placeholder="{{ $data['announcement']->general_announcement_id }}" class="INPUT">
                        </div>
                        ...
                        <div class="row">
                            <textarea style="resize: none;" id="announcement_content" name="announcement_content" required
                                 placeholder="{{$data ['announcement']->announcement_content}} "  class="INPUT_2"></textarea>
                                {{-- {{$data ['announcement']->announcement_content}} --}}
                            </div>
                ...
                <form id="del" action="{{ route('get-delete-announcement', ['announcementId' => $data['announcement']->general_announcement_id]) }}" method="GET">
